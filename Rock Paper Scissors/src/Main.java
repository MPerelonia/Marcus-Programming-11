...
public class Main {
    public static void main(String[] args) {
        ...
        //This is the randomizer.  Every number, 0, 1, and 2 are given an associated move.  0 is rock, 1 is paper, and 2 is scissors.
        ...
        //This just asks the player "what do you choose?" and checks what the player typed.
        System.out.println("What do you choose?");
        player = scan.next();

        //This checks if the player or computer wins.  If none of them win, then it checks if the 2 moves equal each other.  If they do, then it is a tie.
        ...
        //This says what the computer chose
        ...
        //This says what the player chose
        if (player.equals("r")) {
